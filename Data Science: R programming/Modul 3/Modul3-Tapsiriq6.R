...
categorical_columns = colnames(select_if(data, is.factor)) #kategorik deyisken olmadigi ucun character deyiskenlerden istifade etdim.
...
character_columns <- colnames(data)[sapply(data, is.character)]
